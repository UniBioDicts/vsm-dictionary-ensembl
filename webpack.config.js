/*
This Webpack-config builds a version of VsmDictionaryEnsembl that can be
...
module.exports = (env = {}) => ({
  ...
  entry: src + '/DictionaryEnsembl.js',
  ...
  output: {
    path: dist,
    filename: 'vsm-dictionary-ensembl.min.js',
    library: 'VsmDictionaryEnsembl',
    libraryTarget: 'var'
  }
});
